...
<div class="container mt-5 col-md-6">
    <h4 class="text-center">Adicionar Livro</h4>
    ...
    <form action="livro" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="titulo" placeholder="Título" name="titulo" maxlength="255" required>
        </div>
        <div class="form-group">
            <label for="autor">Autor</label>
            <input type="text" class="form-control" id="autor" placeholder="Autor" name="autor" maxlength="255" required>
        </div>
        <div class="form-group">
            <label for="descricao">Descrição</label>
            <input type="text" class="form-control" id="descricao" placeholder="Descrição" name="descricao" maxlength="255" required>
        </div>
        <div class="form-group">
            <label for="preco">Preço unitário</label>
            <input type="number" step="0.01" class="form-control" id="preco" placeholder="Preço" name="preco" min="1" max="1000000.00" required>
        </div>
        <div class="form-group">
            <label for="url">URL da imagem (opcional)</label>
            <input type="text" class="form-control" id="url" placeholder="URL" name="url" maxlength="255">
        </div>
        <div class="form-group">
            <label for="qntd_livros">Quantidade de livros</label>
            <input type="number" class="form-control" id="qntd_livros" placeholder="Quantidade de livros" name="qntd_livros" min="1" max="1000000" value="1" required>
        </div>
        <div class="form-group">
...
<!-- Botões -->
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="hidden" name="idClienteDono" value="<%= session.getAttribute("id") %>">
                <button type="submit" class="btn btn-success btn-block">Adicionar Livro</button>
            </div>
        </div>
    </form>
